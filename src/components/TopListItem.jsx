            ...
            <div className="flex space-x-4 flex-nowrap">
                {Items.map((category) => {
                    return (
                        <div
                            key={category}
                            className="mb-2 ml-2 flex-none whitespace-nowrap border-gray-200 border-2 rounded-lg bg-gray-200 text-black py-1 px-4 hover:bg-gray-800 hover:text-white cursor-pointer font-medium"
                        >
                            {category}
                        </div>
                    );
